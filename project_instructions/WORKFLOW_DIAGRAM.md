...
```mermaid
flowchart TD
    Project[🎯 Project Progress] --> Status[📄 status.md<br/>Module Level]
    Project --> Plan[📋 high_level_plan.md<br/>Phase Level]
    Project --> Impl[📁 implementation_plan/<br/>Task Level]
    ...
    Impl --> Phase1[📁 phase1_foundation/<br/>✅ 12/12 tasks]
    Impl --> Phase2[📁 phase2_database/<br/>🔄 8/16 tasks]
    Impl --> Phase3[📁 phase3_backend/<br/>⏸️ 0/15 tasks]
...
```mermaid
flowchart LR
    Instructions[📁 project_instructions/<br/>🔒 READ ONLY<br/>Never Modified] --> Agent[🤖 AI Agent]
    
    Agent --> Working[📁 project_working_files/<br/>✏️ WRITE AREA<br/>All Agent Work]
